{
  ...
  '#':: d.pkg(name='sealedSecret', url='', help="\"SealedSecret is the K8s representation of a \\\"sealed Secret\\\" - a\\nregular k8s Secret that has been sealed (encrypted) using the\\ncontroller's key.\""),
  ...
  '#new':: d.fn(help='new returns an instance of SealedSecret', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'bitnami.com/v1alpha1',
    kind: 'SealedSecret',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"SealedSecretSpec is the specification of a SealedSecret."'),
  spec: {
    '#template':: d.obj(help='"Template defines the structure of the Secret that will be\\ncreated from this sealed secret."'),
    template: {
      ...
      '#withData':: d.fn(help='"Keys that should be templated using decrypted data."', args=[d.arg(name='data', type=d.T.object)]),
      withData(data): { spec+: { template+: { data: data } } },
      '#withDataMixin':: d.fn(help='"Keys that should be templated using decrypted data."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='data', type=d.T.object)]),
      withDataMixin(data): { spec+: { template+: { data+: data } } },
      '#withImmutable':: d.fn(help='"Immutable, if set to true, ensures that data stored in the Secret cannot\\nbe updated (only object metadata can be modified).\\nIf not set to true, the field can be modified at any time.\\nDefaulted to nil."', args=[d.arg(name='immutable', type=d.T.boolean)]),
      withImmutable(immutable): { spec+: { template+: { immutable: immutable } } },
    ...
    '#withData':: d.fn(help='"Data is deprecated and will be removed eventually. Use per-value EncryptedData instead."', args=[d.arg(name='data', type=d.T.string)]),
    withData(data): { spec+: { data: data } },
    '#withEncryptedData':: d.fn(help='', args=[d.arg(name='encryptedData', type=d.T.object)]),
    withEncryptedData(encryptedData): { spec+: { encryptedData: encryptedData } },
    '#withEncryptedDataMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='encryptedData', type=d.T.object)]),
    withEncryptedDataMixin(encryptedData): { spec+: { encryptedData+: encryptedData } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
